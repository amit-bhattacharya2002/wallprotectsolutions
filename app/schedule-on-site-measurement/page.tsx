      ...
      <main>
            ...
            <div className="grid lg:grid-cols-3 gap-16">
                ...
                <div className="sticky top-32">
                  ...
                  <div className="surface-card-muted p-6 mb-8">
                    ...
                    <ul className="space-y-3 text-sm text-gray-600">
                      <li className="flex items-start gap-3">
                        <svg className="w-5 h-5 text-[#64A70B] mt-0.5 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  ...
                  <div className="surface-card-muted p-6">
                    ...
                    <a 
                      ...
                      className="inline-flex items-center gap-2 text-[#64A70B] hover:text-[#9BCB4A] font-medium transition-colors"
                    >
              ...
              <div className="lg:col-span-2">
                <form onSubmit={handleSubmit} className="surface-card-muted p-8 lg:p-10">
                  ...
                  <button
                    type="submit"
                    className="w-full bg-[#005EB8] text-white px-8 py-4 rounded-full font-medium transition-all hover:bg-[#64A70B] mt-8"
                  >
        ...
        <section className="section-shell bg-[#f8fafc] border-t border-gray-100">
          <div className="max-w-4xl mx-auto px-6 lg:px-8 text-center">
            <div className="flex items-center justify-center gap-2 text-[#64A70B] mb-4">
              <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
