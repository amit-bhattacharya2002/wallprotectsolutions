    ...
    <>
      ...
      <main>
        <PageHero
          ...
          title="Panolam Wall Panels"
          subtitle="Quality FRP and FRL wall panels for commercial applications. Trusted solutions for food service, healthcare, and decorative wall protection needs."
          ...
          quickLinks={[
            ...
            { label: "Graham FRP", href: "/wall-protection/manufacturers/graham" },
                      ...
                      <div className="mb-6">
                        ...
                        <div className="flex flex-wrap gap-2">
                          {product.options.fireRatings.map((rating) => (
                            <span key={rating} className="inline-block border-b border-slate-300 pb-1 text-sm text-slate-600">
                              {rating}
                            </span>
                          ))}
                        </div>
                      ...
                      <div className="mb-6">
                        ...
                        <div className="flex flex-wrap gap-2">
                          {product.options.categories.map((cat) => (
                            <span key={cat} className="inline-block border-b border-slate-300 pb-1 text-sm text-slate-600">
                              {cat}
                            </span>
                          ))}
                        </div>
