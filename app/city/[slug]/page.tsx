...
export default async function CityPage({ params }: { params: Promise<{ slug: string }> }) {
  ...
  const heroQuickLinks = nearbyCities.slice(0, 4).map((nearbyCity) => ({
              ...
              <div>
                ...
                <div className="mt-8 flex flex-wrap gap-3">
                  ...
                  <Link
                    ...
                    className="inline-flex items-center gap-3 border border-gray-300 text-[#0f172a] px-6 py-3 rounded-full font-medium hover:border-[#0d9488] hover:text-[#0d9488] transition-all"
                  >
                    FRP Options
                  </Link>
                </div>
                  ...
                  <div className="space-y-3">
                    {frpManufacturers.map((mfr) => (
                      <Link
                        key={mfr.name}
                        href={mfr.href}
                        className="flex items-center justify-between p-4 bg-white rounded-xl border border-gray-200 hover:border-[#0d9488] transition-colors group"
                      >
                        <span className="font-medium text-[#0f172a] group-hover:text-[#0d9488] transition-colors">
                          {mfr.name}
                        </span>
                        <svg className="w-4 h-4 text-gray-500 group-hover:text-[#0d9488] transition-colors" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
              ...
              <div className="surface-card-muted p-8 lg:p-10">
                <div className="flex items-start gap-4 mb-8">
                  ...
                  <div>
                    <h3 className="text-[#0f172a] font-semibold mb-2">Pro Tip</h3>
                ...
                <h3 className="text-[#0f172a] font-semibold mb-4">General Contractors Corner</h3>
              ...
              <div className="flex flex-wrap gap-3">
                {nearbyCities.map((nearbyCity) => (
                  <Link
                    key={nearbyCity.slug}
                    href={`/city/${nearbyCity.slug}`}
                    className="px-5 py-2.5 bg-white border border-gray-200 rounded-full text-gray-700 hover:border-[#0d9488] hover:text-[#0d9488] transition-colors font-medium"
                  >
                    {nearbyCity.name}
                  </Link>
                ))}
