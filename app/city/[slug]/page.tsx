                  ...
                  <div className="space-y-3">
                    {frpManufacturers.map((mfr) => (
                      <Link
                        key={mfr.name}
                        href={mfr.href}
                        className="flex items-center justify-between p-4 bg-white rounded-xl border border-gray-200 hover:border-[#64A70B] transition-colors group"
                      >
                        <span className="font-medium text-[#0f172a] group-hover:text-[#64A70B] transition-colors">
                          {mfr.name}
                        </span>
                        <svg className="w-4 h-4 text-gray-500 group-hover:text-[#64A70B] transition-colors" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <div className="max-w-7xl mx-auto px-6 lg:px-8">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
              {otherManufacturers.map((mfr) => (
                ...
                >
                  <span className="text-xs text-[#64A70B] font-medium uppercase tracking-wider block mb-2">
                    {mfr.type}
                  </span>
            ...
            <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-start">
              ...
              <div className="surface-card-muted p-8 lg:p-10 sticky-side">
                <div className="flex items-start gap-4 mb-8">
                  <div className="w-12 h-12 rounded-full bg-[#005EB8] flex items-center justify-center shrink-0">
