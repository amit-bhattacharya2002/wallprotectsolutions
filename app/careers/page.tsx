  ...
  return (
    <>
      ...
      <main>
        <PageHero
          visual="photo"
          backgroundPhoto={sitePhotos.careers}
        ...
        <section className="section-shell-lg bg-white">
          <div className="max-w-7xl mx-auto px-6 lg:px-8">
            <div className="max-w-2xl mb-14">
              <span className="text-sm font-medium text-[#64A70B] tracking-wider uppercase mb-4 block">Roles</span>
            ...
            <div className="grid md:grid-cols-3 gap-8">
              {roles.map((role, index) => (
                <div
                  ...
                  className="surface-card scroll-mt-32 p-8 hover:border-[#64A70B] transition-colors"
                >
