...
export default function Testimonials() {
  ...
  return (
    <section id="testimonials" className="section-shell-lg section-shell-dark bg-[#0f172a]">
        ...
        <div className="grid lg:grid-cols-2 gap-10 lg:gap-16">
          ...
          <div>
            ...
            <div className="surface-card-dark inline-flex items-center gap-4 p-6">
              <div className="flex gap-1">
                {[1, 2, 3, 4, 5].map((star) => (
                  <svg key={star} className="w-5 h-5 text-[#0d9488]" fill="currentColor" viewBox="0 0 20 20">
          ...
          <div className="relative">
            ...
            <div className="surface-card-dark p-8 lg:p-10">
              <svg className="w-10 h-10 text-[#0d9488] mb-6" fill="currentColor" viewBox="0 0 24 24">
              ...
              <div className="flex items-center gap-4">
                <div className="w-12 h-12 rounded-full bg-[#0d9488] flex items-center justify-center text-white font-semibold text-lg">
