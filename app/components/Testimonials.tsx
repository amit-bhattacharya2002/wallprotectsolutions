...
export default function Testimonials() {
  ...
  return (
    <section id="testimonials" className="section-shell-lg section-shell-dark bg-[#2a4663]">
      <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-8">
        <div className="grid lg:grid-cols-2 gap-10 lg:gap-16">
          {/* Left Column */}
          <div>
            <span className="eyebrow">Testimonials</span>
            <h2 className="section-title section-title-dark mb-4">
              What our clients say
            </h2>
            <p className="section-lead section-lead-dark mb-8">
              Don&apos;t just take our word for it. Here&apos;s what clients across British Columbia say about our work.
            </p>

            {/* Google Rating */}
            <div className="surface-card-dark inline-flex items-center gap-4 p-6">
              <div className="flex gap-1">
                {[1, 2, 3, 4, 5].map((star) => (
                  <svg key={star} className="w-5 h-5 text-[#5eead4]" fill="currentColor" viewBox="0 0 20 20">
          ...
          <div className="relative">
            {/* Active Testimonial */}
            <div className="surface-card-dark p-8 lg:p-10">
              <svg className="w-10 h-10 text-[#5eead4] mb-6" fill="currentColor" viewBox="0 0 24 24">
                <path d="M14.017 21v-7.391c0-5.704 3.731-9.57 8.983-10.609l.995 2.151c-2.432.917-3.995 3.638-3.995 5.849h4v10h-9.983zm-14.017 0v-7.391c0-5.704 3.748-9.57 9-10.609l.996 2.151c-2.433.917-3.996 3.638-3.996 5.849h3.983v10h-9.983z" />
              </svg>
              
              <p className="text-base md:text-lg text-white leading-relaxed mb-8 font-normal min-h-[120px]">
                &ldquo;{testimonials[activeIndex].content}&rdquo;
              </p>

              <div className="flex items-center gap-4">
                <div className="w-12 h-12 rounded-full bg-[#134e4a] flex items-center justify-center text-white font-semibold text-lg">
